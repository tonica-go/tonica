...
7. [**Middleware Routing Guide**](./middleware-routing.md) - Добавление кастомных HTTP групп маршрутов с Мидлварями
8. [**Руководство по тестированию**](./testing.md) - Как тестировать Tonica приложения
9. [**Лучшие практики**](./best-practices.md) - Паттерны, антипаттерны и рекомендации
